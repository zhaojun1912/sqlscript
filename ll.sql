...
--Êü•ËØ¢ÂàÜÈíüÈáèÂèäÊµÅÈáè‰ΩøÁî®ÊòéÁªÜÔºàÊØèÂè∑Á†ÅÊØèÊúà‰∏ÄÊù°Êï∞ÊçÆÔºâ Ôºå ÊØèÊúàÊ±áÊÄª„ÄÇ
SELECT
tm.tmcode,
tm.des,
lnk.TM_GROUP_ID,
...
--Êü•ËØ¢‰∏ªË¥¶Âè∑‰∏ãÊâÄÊúâÂ≠êË¥¶Âè∑ÁöÑÊµÅÈáèÈôêÂà∂
...
/*Êü•ËØ¢ÂÖ¨Âè∏Ë¥¶Âè∑‰∏ãÂêÑÁé∞ÁîüÊïàÁî®Êà∑ÊòØÂê¶ÂºÄÈÄöÊüêÊúçÂä°*/
WITH t AS
...
∂‘”⁄ptcbill_free_unit£¨“ª∞„”–»˝Ãıº«¬º£¨HK £¨  HK&China  £¨¥Û÷–ª™£¨µ´ «÷ªƒ‹”√∆‰÷–“ªÃı
